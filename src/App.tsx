...
// ✅ iconMap COMPLETO con TODOS los iconos
...
// ✅ Función helper para obtener iconos con fallback
...
export default function App() {
  ...
  // ✅ DATOS CON FALLBACK COMPLETO
  const currentLang = i18n.language as keyof typeof allData;
  const rawData = allData[currentLang] || dataES;
  ...
  return (
    <div className="relative overflow-x-hidden min-h-screen text-gray-200 font-sans selection:bg-[#00F0FF]/30">
      ...
      <div className="relative z-10 flex flex-col">
              ...
              <div className="lg:col-span-7 space-y-8">
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2.5 mb-6">
                    {(data?.about?.badges || []).map((badge: any, idx: number) => {
                  ...
                  {(() => {
                    const activeBadge = data?.about?.badges?.[activeSkillIdx] || null;
          ...
          <div className="container mx-auto max-w-6xl px-4 relative z-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
              <div className="lg:col-span-6 space-y-4">
                {(data?.about?.career || []).map((block: any, idx: number) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-2">
                        {(block?.roles || []).map((role: string, i: number) => (
                          <span 
        ...
        {/* PROCESS MAPPING SECTION - Simplified for brevity */}
        <section id="procesos" className="py-24 relative z-10 bg-black/60 backdrop-blur-md border-t border-white/5">
          <div className="container mx-auto max-w-6xl px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {(data?.expertise?.areas || []).map((area: any, idx: number) => {
