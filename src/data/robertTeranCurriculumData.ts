...
export const ALL_LEARNING_ACTIVITIES: LearningActivity[] = [
  ...
  { code: "PLAN-8749C02A78EC-ACT", title: "Web Development Fundamentals (Earn a credential!)" },
  { code: "MDL-266", title: "Develop an Interactive Task List Web Page" },
  { code: "PLAN-3749C72117E2-ACT", title: "User Experience Design Fundamentals (Earn a credential!)" },
  ...
  { code: "PLAN-BFB9EE6140A8-ACT", title: "Esenciales de Marketing - ¡Obtén una insignia!" },
  ...
  { code: "PLAN-7913EE1DB030-ACT", title: "Artificial Intelligence Fundamentals (Earn a credential!)" },
  ...
  { code: "PLAN-BC0FAEE8E439-ACT", title: "Data Fundamentals (Earn a credential!)" },
  ...
  { code: "PLAN-FA511CDFAF48-ACT", title: "Cybersecurity Fundamentals (Earn a credential!)" },
